(function(global) {
  ...
  var moduleId = "piewpiew.ui.TemplatableView";
  var requires = ["exports", "piewpiew", "piewpiew.ui.View", "piewpiew.ui.TemplateContext"];

  var module = function(exports, piewpiew, view, templateContext) {
    ...
    exports.TemplatableView = piewpiew.Class(view.View, {
      ...
      initializeWithSpec: function(spec) {
        ...
        view.View.prototype.initializeWithSpec.apply(this, [spec]);
      },

      render: function() {
        var that = this;
        var context = new templateContext.TemplateContext(this.toJSON());
      ...
      renderTemplate: function(context, callback) {
        var p = exports.TemplatableView.getTemplateParser();
     ...
     * @return {Function}
     */
    exports.TemplatableView.getTemplateParser = function() {
     ...
     */
    exports.TemplatableView.setTemplateParser = function(parser) {
